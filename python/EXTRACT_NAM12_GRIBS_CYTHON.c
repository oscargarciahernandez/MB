...
{
    "distutils": {
        "name": "EXTRACT_NAM12_GRIBS_CYTHON",
        "sources": [
            "EXTRACT_NAM12_GRIBS_CYTHON.pyx"
        ]
    },
    "module_name": "EXTRACT_NAM12_GRIBS_CYTHON"
}
END: Cython Metadata */
...
#define __PYX_HAVE__EXTRACT_NAM12_GRIBS_CYTHON
#define __PYX_HAVE_API__EXTRACT_NAM12_GRIBS_CYTHON
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'EXTRACT_NAM12_GRIBS_CYTHON' */
#define __Pyx_MODULE_NAME "EXTRACT_NAM12_GRIBS_CYTHON"
extern int __pyx_module_is_main_EXTRACT_NAM12_GRIBS_CYTHON;
int __pyx_module_is_main_EXTRACT_NAM12_GRIBS_CYTHON = 0;

/* Implementation of 'EXTRACT_NAM12_GRIBS_CYTHON' */
...
/* Python wrapper */
static PyObject *__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_1EXTRACT_VARIABLES_FROM_GRIB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":34
 * 
 *     VARIABLE_NAMES=[]
 *     k=1             # <<<<<<<<<<<<<<
 *     HRRR_GRIB.seek(0)
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":40
 *         k=k+1
 * 
 *     colnames=  ['index','NAME', 'UNITS', 'PROJ', 'TYPE_VAR', 'LEVEL_Pa', 'TIMESTAMP', 'DATE']             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":41
 * 
 *     colnames=  ['index','NAME', 'UNITS', 'PROJ', 'TYPE_VAR', 'LEVEL_Pa', 'TIMESTAMP', 'DATE']
 *     TABLA_VAR= pd.DataFrame(VARIABLE_NAMES, columns= colnames)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":47
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":53
 *         os.makedirs(PATH_SAVE, exist_ok=True)
 * 
 *     print('TABLA DE VARIABLES GUARDADA EN ' + PATH_SAVE + 'TABLA_VARIABLES.csv')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":54
 * 
 *     print('TABLA DE VARIABLES GUARDADA EN ' + PATH_SAVE + 'TABLA_VARIABLES.csv')
 *     print('TABLA DE VARIABLES DE VIENTO GUARDADA EN ' + PATH_SAVE + 'TABLA_WIND.csv')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":56
 *     print('TABLA DE VARIABLES DE VIENTO GUARDADA EN ' + PATH_SAVE + 'TABLA_WIND.csv')
 * 
 *     TABLA_CUSTOM.to_csv(PATH_SAVE + 'TABLA_'+ CUSTOM_WORD+'.csv', index = False, sep= ';')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":57
 * 
 *     TABLA_CUSTOM.to_csv(PATH_SAVE + 'TABLA_'+ CUSTOM_WORD+'.csv', index = False, sep= ';')
 *     TABLA_VAR.to_csv(PATH_SAVE + 'TABLA_VARIABLES.csv', index = False, sep= ';')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":59
 *     TABLA_VAR.to_csv(PATH_SAVE + 'TABLA_VARIABLES.csv', index = False, sep= ';')
 * 
 *     return TABLA_VAR             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_3OBTAIN_50_NEAREST_POINTS(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_26EXTRACT_NAM12_GRIBS_CYTHON_2OBTAIN_50_NEAREST_POINTS[] = "\n    FUNCION PARA OBTENER LOS 50 PUNTOS MAS CERCANOS A LA ZONA A ESTUDIAR...\n    SACAR INFORMACION DE TODOS LOS PUNTOS ES MUY EXIGENTE PARA ESTE SCRIPT\n    ";
static PyMethodDef __pyx_mdef_26EXTRACT_NAM12_GRIBS_CYTHON_3OBTAIN_50_NEAREST_POINTS = {"OBTAIN_50_NEAREST_POINTS", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_3OBTAIN_50_NEAREST_POINTS, METH_VARARGS|METH_KEYWORDS, __pyx_doc_26EXTRACT_NAM12_GRIBS_CYTHON_2OBTAIN_50_NEAREST_POINTS};
static PyObject *__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_3OBTAIN_50_NEAREST_POINTS(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_26EXTRACT_NAM12_GRIBS_CYTHON_2OBTAIN_50_NEAREST_POINTS(__pyx_self, __pyx_v_LONG_NP, __pyx_v_LAT_NP, __pyx_v_LON, __pyx_v_LAT);
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":70
 * 
 *     TABLA_LONLAT=pd.DataFrame(columns=['LON', 'LAT'])
 *     TABLA_LONLAT['LON']= LONG_NP[:, :].ravel()             # <<<<<<<<<<<<<<
 *     TABLA_LONLAT['LAT']= LAT_NP[:, :].ravel()
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":71
 *     TABLA_LONLAT=pd.DataFrame(columns=['LON', 'LAT'])
 *     TABLA_LONLAT['LON']= LONG_NP[:, :].ravel()
 *     TABLA_LONLAT['LAT']= LAT_NP[:, :].ravel()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":86
 *     '''
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":88
 *     R = 6373.0
 * 
 *     DISTANCIA= []             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":89
 * 
 *     DISTANCIA= []
 *     for i in range(len(TABLA_LONLAT['LAT'])):             # <<<<<<<<<<<<<<
 *         lat1 = radians(TABLA_LONLAT['LAT'][i])
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    ...
    /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":90
 *     DISTANCIA= []
 *     for i in range(len(TABLA_LONLAT['LAT'])):
 *         lat1 = radians(TABLA_LONLAT['LAT'][i])             # <<<<<<<<<<<<<<
 *         lon1 = radians(TABLA_LONLAT['LON'][i])
 ...
 */
    ...
    /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":98
 *         dlat = lat2 - lat1
 * 
 *         a = sin(dlat / 2)**2 + cos(lat1) * cos(lat2) * sin(dlon / 2)**2             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (;;) {
    ...
    /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":122
 *     for i in range(SELECTED_VARIABLES.shape[0]):
 * 
 *         VAR_LEVEL= SELECTED_VARIABLES['LEVEL_Pa'].iloc[i]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":123
 * 
 *         VAR_LEVEL= SELECTED_VARIABLES['LEVEL_Pa'].iloc[i]
 *         VAR_NAME= SELECTED_VARIABLES['NAME'].iloc[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":128
 * 
 *         if os.path.isfile(NOMBRE_ARCHIVO):
 *             print(NOMBRE_ARCHIVO +  ' YA EXISTE')             # <<<<<<<<<<<<<<
 *         else:
...
/* Python wrapper */
static PyObject *__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_7MAIN(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_26EXTRACT_NAM12_GRIBS_CYTHON_7MAIN = {"MAIN", (PyCFunction)__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_7MAIN, METH_NOARGS, 0};
static PyObject *__pyx_pw_26EXTRACT_NAM12_GRIBS_CYTHON_7MAIN(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("MAIN (wrapper)", 0);
  __pyx_r = __pyx_pf_26EXTRACT_NAM12_GRIBS_CYTHON_6MAIN(__pyx_self);
...
static int __pyx_pymod_exec_EXTRACT_NAM12_GRIBS_CYTHON(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_EXTRACT_NAM12_GRIBS_CYTHON},
  {0, NULL}
};
#endif
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":19
 * 
 * 
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":20
 * 
 * pd.set_option('display.max_columns', 15)
 * pd.set_option('display.max_rows', 30)             # <<<<<<<<<<<<<<
 * 
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initEXTRACT_NAM12_GRIBS_CYTHON(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initEXTRACT_NAM12_GRIBS_CYTHON(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_EXTRACT_NAM12_GRIBS_CYTHON(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_EXTRACT_NAM12_GRIBS_CYTHON(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_EXTRACT_NAM12_GRIBS_CYTHON(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'EXTRACT_NAM12_GRIBS_CYTHON' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_EXTRACT_NAM12_GRIBS_CYTHON(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("EXTRACT_NAM12_GRIBS_CYTHON", __pyx_methods, __pyx_k_Created_on_Fri_Aug_23_13_17_24, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_EXTRACT_NAM12_GRIBS_CYTHON) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "EXTRACT_NAM12_GRIBS_CYTHON")) {
      if (unlikely(PyDict_SetItemString(modules, "EXTRACT_NAM12_GRIBS_CYTHON", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":9
 * """
 * 
 * import pygrib             # <<<<<<<<<<<<<<
 * import os
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":10
 * 
 * import pygrib
 * import os             # <<<<<<<<<<<<<<
 * import pandas as pd
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":11
 * import pygrib
 * import os
 * import pandas as pd             # <<<<<<<<<<<<<<
 * from math import sin, cos, sqrt, atan2, radians
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":12
 * import os
 * import pandas as pd
 * from math import sin, cos, sqrt, atan2, radians             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":13
 * import pandas as pd
 * from math import sin, cos, sqrt, atan2, radians
 * import numpy as np             # <<<<<<<<<<<<<<
 * import re
 ...
 */
  ...
  /* "EXTRACT_NAM12_GRIBS_CYTHON.pyx":14
 * from math import sin, cos, sqrt, atan2, radians
 * import numpy as np
 * import re             # <<<<<<<<<<<<<<
 * import cython
 ...
 *     FUNCION QUE NOS DEVUELVE LA TABLA DE VARIABLES CONTENIDA EN EL GRIB... Y LA GUARDA A UN CSV
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_26EXTRACT_NAM12_GRIBS_CYTHON_1EXTRACT_VARIABLES_FROM_GRIB, NULL, __pyx_n_s_EXTRACT_NAM12_GRIBS_CYTHON); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     FUNCION PARA OBTENER LOS 50 PUNTOS MAS CERCANOS A LA ZONA A ESTUDIAR...
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_26EXTRACT_NAM12_GRIBS_CYTHON_3OBTAIN_50_NEAREST_POINTS, NULL, __pyx_n_s_EXTRACT_NAM12_GRIBS_CYTHON); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init EXTRACT_NAM12_GRIBS_CYTHON", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init EXTRACT_NAM12_GRIBS_CYTHON");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
