...
GRIB_SOURCE=  '/media/meteobit/Elements/GRIBS_025_2019/'
...
for FECHA_EJECUCION in dias_2018[1:]: 
    ...
    if FECHA_EJECUCION in SIMULACIONES_HECHAS:
        ...
        command_modelo= './ems_prep --date ' +  FECHA_EJECUCION + ' --cycle 00:00:48 --dset gfsp25 --sleep 1 --attempts 10 --domain 1,2,3 && ./ems_run --domain 1,2,3'
        ...
        if resultado == 'fracaso':
            ...
            #CREAMOS EL COMANDO ANADIENDO LA FECHA DE EJECUCION 
            command_modelo= './ems_prep --date ' +  FECHA_EJECUCION + ' --cycle 06:00:42 --dset gfsp25 --sleep 1 --attempts 10 --domain 1,2,3 && ./ems_run --domain 1,2,3'
            print('\n Ejecutamos modelo para el dia ' + FECHA_EJECUCION + ' --- ' + str(datetime.datetime.now())[:-7])
            ...
            if resultado == 'fracaso':
                print('\n ERROR. El modelo para el dia ' + FECHA_EJECUCION + ' HA FALLADO. Volvemos a intentarlo con otro grib --- '+ str(datetime.datetime.now())[:-7])
                #CREAMOS EL COMANDO ANADIENDO LA FECHA DE EJECUCION 
                command_modelo= './ems_prep --date ' +  FECHA_EJECUCION + ' --cycle 12:00:36 --dset gfsp25 --sleep 1 --attempts 10 --domain 1,2,3 && ./ems_run --domain 1,2,3'
                print('\n Ejecutamos modelo para el dia ' + FECHA_EJECUCION + ' --- ' + str(datetime.datetime.now())[:-7])
                ...
                if resultado == 'fracaso':
                    print('\n ERROR. El modelo para el dia ' + FECHA_EJECUCION + ' HA FALLADO. Volvemos a intentarlo con otro grib --- '+ str(datetime.datetime.now())[:-7])
                    #CREAMOS EL COMANDO ANADIENDO LA FECHA DE EJECUCION 
                    command_modelo= './ems_prep --date ' +  FECHA_EJECUCION + ' --cycle 18:00:30 --dset gfsp25 --sleep 1 --attempts 10 --domain 1,2,3 && ./ems_run --domain 1,2,3'
                    print('\n Ejecutamos modelo para el dia ' + FECHA_EJECUCION + ' --- ' + str(datetime.datetime.now())[:-7])
